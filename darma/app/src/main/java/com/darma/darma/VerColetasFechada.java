...
public class VerColetasFechada extends AppCompatActivity implements ListView.OnItemClickListener {
    ...
    private void showColetas(){
        ...
        ListAdapter adapter = new SimpleAdapter(
                VerColetasFechada.this, list, R.layout.list_item,
    ...
    private void getJSON(){
        class GetJSON extends AsyncTask<Void,Void,String>{
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(VerColetasFechada.this,"Buscando","Aguarde...",false,false);
            }
            ...
            protected String doInBackground(Void... params) {
                ...
                String s = rh.sendGetRequest(Config.URL_GET_ALL_CLOSED);
                return s;
            }
        }
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        Intent intent = new Intent(this, RelatorioFechado.class);
