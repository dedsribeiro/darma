...
public class RelatorioFechado extends AppCompatActivity {
    ...
    private TextView txDataFechada;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_relatorio_fechado);
        ...
        txDataFechada = (TextView) findViewById(R.id.dataRetirada);
    ...
    private void getEmployee(){
        class GetEmployee extends AsyncTask<Void,Void,String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(RelatorioFechado.this,"Buscando","Aguarde...",false,false);
            }
            ...
            protected String doInBackground(Void... params) {
                ...
                String s = rh.sendGetRequestParam(Config.URL_GET_CLOSED,id);
                return s;
            }
        }
    ...
    private void showEmployee(String json){
        try {
            ...
            String dt_retirada = c.getString(Config.TAG_DATA_RETIRADA);
            //txId.setText(id);
            txNome.setText(nome);
            ...
            txDataFechada.setText(dt_retirada);
